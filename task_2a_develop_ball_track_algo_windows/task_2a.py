...
# Team ID:          [ 2433 ]
# Author List:      [ Names of team members worked on this file separated by Comma: Harsh,Saksham,Bhargav,Rahul]
# Filename:         task_2a.py
...
def get_vision_sensor_image():
	...
	##############	ADD YOUR CODE HERE	##############
	ret,handle=sim.simxGetObjectHandle(client_id,'vision_sensor_1',sim.simx_opmode_blocking)
	#imageAcquisitionTime=sim.simxGetLastCmdTime(client_id)
...
def exit_remote_api_server():
	...
	# Now close the conne ction toCoppeliaSim:
